...
var useIpFromHostname = flag.Bool("useIpFromHostname", false, "Use IP resolved from Config.Hostname, if NetworkMode detects empty IP")
...
func main() {
	...
	b, err := bridge.New(docker, flag.Arg(0), bridge.Config{
		...
		UseIpFromHostname: *useIpFromHostname,
		ForceTags:         *forceTags,
